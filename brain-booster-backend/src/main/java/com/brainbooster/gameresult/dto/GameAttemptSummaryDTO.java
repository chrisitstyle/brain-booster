...
@Schema(description = "Summary response containing basic information about a completed game attempt.")
public record GameAttemptSummaryDTO(
        ...
        @Schema(
                description = "Game mode related to the attempt.",
