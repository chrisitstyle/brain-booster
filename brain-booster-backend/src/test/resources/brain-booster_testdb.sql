...
(
    ...
    created_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT folder_user_id_fkey FOREIGN KEY (user_id) REFERENCES "user" (user_id) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT folder_flashcard_set_folder_id_fkey
        FOREIGN KEY (folder_id) REFERENCES FOLDER (folder_id) ON DELETE CASCADE,

    CONSTRAINT folder_flashcard_set_set_id_fkey
...
ALTER TABLE FOLDER
    ALTER COLUMN folder_id RESTART WITH 100;