...
-- add dedicated users for integration tests
INSERT INTO "user" (user_id, nickname, email, password, role, created_at)
VALUES (2, 'it-user1', 'it-user1@test.com', '$2a$10$LV8wtoOAffLu7OuBIo/5EelC7B3xz2Du8v9nneLRWDYxOXalh1sPa', 'USER', CURRENT_TIMESTAMP);

INSERT INTO "user" (user_id, nickname, email, password, role, created_at)
VALUES (3, 'it-user2', 'it-user2@test.com', '$2a$10$LV8wtoOAffLu7OuBIo/5EelC7B3xz2Du8v9nneLRWDYxOXalh1sPa', 'USER', CURRENT_TIMESTAMP);
